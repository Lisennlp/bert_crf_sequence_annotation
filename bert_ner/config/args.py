...
RAW_SOURCE_CWS_TRAIN_DATA = "../bert_ner/data/cws_data/cws.train"   # 源数据路径
RAW_SOURCE_CWS_TEST_DATA = "../bert_ner/data/cws_data/cws.test"   # 源数据路径

RAW_CWS_MID_TRAIN_DATA = "../bert_ner/data/cws.train.json"   # 源数据路径
RAW_CWS_MID_TEST_DATA = "../bert_ner/data/cws.dev.json"   # 源数据路径
...
# VALID = "data/dev.json"
TRAIN = "data/cws.train.json"
VALID = "data/cws.dev.json"
